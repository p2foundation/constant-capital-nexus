        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex items-center">
              <div className="text-sm text-gray-300 mr-4">SEC License: <span className="text-white">SD-001/15</span></div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>
                <Link to="/financings-capital-markets" className="hover:text-cc-gold transition-colors">
                  Financings $ Capital Markets
                </Link>
              </li>
              <li>
                <Link to="/research-services" className="hover:text-cc-gold transition-colors">
                  Research Services
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li className="flex items-center">
                <span className="mr-2">📞</span>
                <span>+233 302 738 242</span>
              </li>
              <li className="flex items-center">
                <span className="mr-2">📧</span>
                <span>info@constantcapital.com.gh</span>
              </li>
            </ul>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full border border-gray-600 flex items-center justify-center hover:border-cc-gold transition-colors">
