...
const ClientsCarousel = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-cc-navy/80 dark:to-cc-navy overflow-hidden relative">
      <div className="container mx-auto px-4">
        <div className="text-left mb-16">
          <div className="text-cc-gold uppercase tracking-wide font-medium mb-4">OUR REGULATORS</div>
          <h2 className="text-4xl md:text-5xl font-bold text-cc-navy dark:text-white mb-6">
              ...
              <CarouselContent className="-ml-8 md:-ml-12">
                {partners.map((partner, index) => (
                  <CarouselItem 
                    ...
                    className="pl-8 md:pl-12 basis-1/2 md:basis-1/3 lg:basis-1/4 xl:basis-1/5"
                  >
                    <div className="p-4">
                      <div 
                        className={cn(
                          ...
                          "bg-white dark:bg-cc-navy/50 rounded-xl shadow-lg",
                          "hover:shadow-xl",
                          activeIndex === index && "ring-2 ring-cc-gold"
                        )}
                      >
                        <img 
                          src={partner.logo} 
        ...
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-32 h-full bg-gradient-to-r from-gray-50 to-transparent dark:from-cc-navy/80 pointer-events-none"></div>
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-32 h-full bg-gradient-to-l from-gray-50 to-transparent dark:from-cc-navy/80 pointer-events-none"></div>
      </div>
    </section>
  );
};
