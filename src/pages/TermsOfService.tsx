    ...
    <div className="flex flex-col min-h-screen dark:bg-gray-950">
      ...
      <main className="flex-1 container mx-auto px-6 py-8 pt-20">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 text-cc-navy dark:text-white">Terms of Service</h1>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <section className="mb-6">
              <h2 className="text-xl font-bold mb-3">3. Services</h2>
            ...
            <section className="mb-6">
              <h2 className="text-xl font-bold mb-3">5. Investment Risks</h2>
