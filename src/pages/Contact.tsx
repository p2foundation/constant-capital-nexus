            ...
            <div className="pt-20 flex-grow">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="text-center mb-12">
                        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-cc-navy dark:text-white">Contact
                            Us</h1>
                        <p className="mt-4 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                            We're here to answer any questions you might have about our services, investment
                            opportunities, or how we can help you achieve your financial goals.
                        </p>
                    </div>
                        ...
                        <div className="lg:col-span-1">
                            <Card>
                                <CardContent className="pt-6">
                                    <h3 className="font-medium text-lg mb-4 text-cc-navy dark:text-white">Constant
                                        Capital (Ghana) Limited</h3>
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <a
                                                    ...
                                                    className="text-sm text-gray-600 dark:text-gray-300 hover:text-cc-gold dark:hover:text-cc-gold transition-colors duration-300"
                                                >
                                                    +233 302 500 386
                                                </a>
                                            </div>
                    ...
                    <div className="mt-12">
                        <h2 className="text-2xl font-bold mb-6 text-center text-cc-navy dark:text-white">Our
                            Location</h2>
                        <div
                            className="h-80 w-full rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                            <iframe
